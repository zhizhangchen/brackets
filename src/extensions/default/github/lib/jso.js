(function(exp, $) {
	...
	exp.jso_checkfortoken = function(providerID, url, callback) {
        ...
        //yunpeng added 
        console.log("token is successfully saved");
	...
	var jso_authrequest = function(providerid, scopes, callback) {
		...
		var 
			...
			authurl,
			co;
        console.log("jso_authrequest is successfully called");
		...
		if (co["redirect_uri"]) {
            //yunpeng added tow lines
            console.log("request redirect_uri is" + request["redirect_uri"]);
            console.log("co redirect_uri is " + co["redirect_uri"]);
	...
	exp.jso_configure = function(c, opts) {
	    //yunpeng added 
        console.log("jso_configure is succesfully used");
        config = c;
		setOptions(opts);
		try {
	...
	exp.jso_registerRedirectHandler = function(callback) {
		//yunpeng added
        console.log("jso_registerRedirectHandler is successfully used");
